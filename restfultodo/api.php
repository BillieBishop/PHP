...
DB::$dbName = 'restfultodo';
DB::$user = 'restfultodo';
DB::$password = 'LRXTDJ9eaDNpcqsj';
...
function isTodoItemValid($todo, &$error, $skipID = FALSE) {
    ...
    if (count($tempDate) != 3) {
        ...
        return FALSE;
    } elseif (!checkdate($tempDate[1], $tempDate[2], $tempDate[0]) || date($todo['dueDate']) < date('2000-01-01') || date($todo['dueDate']) > date('2099-01-01')) {
